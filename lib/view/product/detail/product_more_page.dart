      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Builder(
              builder: (context) {
                if (!data.workerOnlineRegist && !data.workerMore.wmoreStayIn) {
                  return profileData(context, key: "Adminstrasi", value: "${rupiah(data.admPrice)}/Hari | ${rupiah(1000000)}", valueBold: true);  
                }
                return profileData(context, key: "Adminstrasi", value: rupiah(data.admPrice), valueBold: true);
              }
            ),
            Builder(
              builder: (context) {
                if (data.workerOnlineRegist) {
                  ...
                  if (data.workerMore.wmoreStayIn) {
                    ...
                    return profileData(context, key: "Gaji", value: "${rupiah(data.categoryPpSalary)}/Hari | ${data.workerSalary}/Bulan", valueBold: true);
                  }
                }
              }
            ),
